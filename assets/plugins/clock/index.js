    ...
    function draw() {
      ...
      var dateRow = { t: 'box', pad: [5, 10], radius: 14, bg: ACCENT + '1F',
        child: { t: 'row', gap: 7, cross: 'center', children: [
          ...
          { t: 'text', font: 'TsukushiBMaru', v: (now.getMonth() + 1) + ' 月 ' + now.getDate() + ' 日', size: 13, opacity: 0.7, trans: true },
          { t: 'text', font: 'TsukushiBMaru', v: week, size: 13, opacity: 0.7, trans: true }
        ] } };
